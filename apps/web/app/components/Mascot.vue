...
/**
 * The glutton — tiny unicode face. Differentiation without a mascot redesign.
 * Mood tracks how full the tightest limit window is.
 */
...
const FACE: Record<string, { eyes: string, mouth: string, tint: string, title: string }> = {
  ...
  content: { eyes: '• •', mouth: '⌣', tint: 'text-foreground', title: 'Nibbling away' },
  full: { eyes: '◕ ◕', mouth: '⌣', tint: 'text-foreground', title: 'Getting full' },
